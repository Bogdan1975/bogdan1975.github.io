...
import {Component, Input, Output, ViewChild, ElementRef, ChangeDetectionStrategy, ChangeDetectorRef, EventEmitter, ContentChildren, QueryList, ViewContainerRef, Renderer} from 'angular2/core'
...
/*        var rangeRangeRibbonStyle = '';
    ...
    ngAfterViewInit() {
        ...
        if (!this._styledDirectives.length) {
            styledInstance = new Ng2StyledDirective(this._elementRef, this._view);
