 ...
 */
System.register(['angular2/core', 'ng2-styled-directive/ng2-styled.directive'], function(exports_1, context_1) {
    "use strict";
            ...
            SlideAbleDirective = (function () {
                ...
                SlideAbleDirective.prototype.ngAfterViewInit = function () {
                    ...
                    window.addEventListener("scroll", function (e) {
                        _this.zeroTop = _this.el.nativeElement.getBoundingClientRect().top - parseInt(getComputedStyle(_this.el.nativeElement).top);
                        if (isNaN(_this.zeroTop))
                            _this.zeroTop = 0;
                        console.log('scroll ');
                    });
                };
