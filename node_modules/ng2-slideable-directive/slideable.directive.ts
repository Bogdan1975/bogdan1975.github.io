...
import {Directive, Input, Output, Renderer, ElementRef, EventEmitter, ContentChildren, QueryList, ViewContainerRef} from 'angular2/core'
...
export class SlideAbleDirective {
    ...
    ngAfterViewInit() {
        ...
        if (!this._styledDirectives.length && this.normalStyle && this.slidingStyle) {
            ...
            this.styledInstance = new Ng2StyledDirective(this.el, this._view);
            var styleBlockArray = [];
